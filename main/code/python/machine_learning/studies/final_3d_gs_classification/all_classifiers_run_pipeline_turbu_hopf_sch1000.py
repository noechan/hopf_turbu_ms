...
data_files = {
    "all_features_turbu_hopf_combat": "Turbu_ComBat_ADNI3_allfeatures_N145_with_infocap_suscep.xlsx",
}

classifier = "LogReg"
classifications = ["HCneg_vs_HCpos", "HCneg_vs_MCIpos","MCIpos_vs_ADapos"]
...
if __name__ == "__main__":
    ...
    for classification in classifications:
        for data_type in data_files.keys():
            ...
            results_folder = (
                    path_repo / "Results" / "final_3d_gs_classification_turbu_hopf_sch1000" /
