...
for the turbulent dynamics feature set.
"""
...
fig_cm.tight_layout()
fig_cm.savefig(
    path_results / f"classification_cm_{scenario.lower()}_turbu_combat.pdf",
    dpi=600,
)
fig_cm.savefig(
    path_results / f"classification_cm_{scenario.lower()}_turbu_combat.svg",
    dpi=600,
)
...
fig_shap.savefig(
    path_results / f"classification_shap_{scenario.lower()}_turbu_combat.pdf",
    dpi=600,
)
fig_shap.savefig(
    path_results / f"classification_shap_{scenario.lower()}_turbu_combat.svg",
    dpi=600,
)
