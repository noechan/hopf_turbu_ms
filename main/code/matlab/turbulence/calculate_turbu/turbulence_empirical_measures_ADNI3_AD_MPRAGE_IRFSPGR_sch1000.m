...
% Load inputs
clear all
cd('/Volumes/ADNI/Projects/2024/ADNI/LONI_IDA/ADNI3/timeseries/inputs_fulldenoising/ADNI3_AD_MPRAGE_IRFSPGR_N238rev/');
...
cd ('/Volumes/ADNI/Projects/2024/ADNI/LONI_IDA/ADNI3/timeseries/outputs_fulldenoising/Turbulence_ADNI3_AD_MPRAGE_IRFSPGR_N238rev_sch1000/')


% Save values
save ('turbu_all_measurements_ADNI3_AD_MPRAGE_IRFSPGR_N238rev_sch1000.mat', 'LAMBDA','Turbulence_global_sub', 'Local_KoP_sub','Transfer_sub', 'InformationCascade_sub', 'TransferLambda_sub','gKoP','Meta');
save ('turbu_by_node_ADNI3_AD_MPRAGE_IRFSPGR_N238rev_sch1000.mat', 'Turbulence_node_sub');
