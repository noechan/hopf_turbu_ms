...
batch_path={'ADNI3_AD_IRFSPGR_batch_1','ADNI3_AD_IRFSPGR_batch_2'};
tseries_path={'ADNI3_AD_IRFSPGR_batch_1_N238rev','ADNI3_AD_IRFSPGR_batch_2_N238rev'};
...
connIDs_filename = sprintf('connIDs_BIDS_IRFSPGR_60_89_batch_%d_AD', batch);
load(connIDs_filename, sprintf('connIDs_BIDS_IRFSPGR_60_89_batch_%d_AD', batch));
...
connIDs = eval(connIDs_varname); % Get connIDs for the current batch
    ...
    cd(input_path_batch);
    save_filename = sprintf('tseries_ADNI3_AD_IRFSPGR_batch_%d_sch1000_matching_QC.mat', batch);
