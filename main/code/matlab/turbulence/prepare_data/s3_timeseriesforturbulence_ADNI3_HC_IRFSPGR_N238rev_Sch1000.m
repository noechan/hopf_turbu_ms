...
batch_path={'ADNI3_HC_IRFSPGR_batch_1'};
...
connIDs_filename = sprintf('connIDs_BIDS_IRFSPGR_60_89_batch_%d_HC', batch);
load(connIDs_filename, sprintf('connIDs_BIDS_IRFSPGR_60_89_batch_%d_HC', batch));
...
connIDs = eval(connIDs_varname); % Get connIDs for the current batch
    ...
    cd(input_path_batch);
    save_filename = sprintf('tseries_ADNI3_HC_IRFSPGR_batch%d_sch1000_matching_QC.mat', batch);
