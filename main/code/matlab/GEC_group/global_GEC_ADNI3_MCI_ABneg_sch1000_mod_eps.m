...
abeta_table = readtable('/Volumes/ADNI/Projects/2024/ADNI/LONI_IDA/ADNI3/participants/cross_sectional/ADNI3_N238rev_with_ABETA_Status.xlsx'); % Adjust path
...
tseries_MCI_ABneg=tseries(isAbetaNeg_MCI,:);

cnd=1;
NSUB=size(tseries_MCI_ABneg,1);
N=1000;
NPARCELLS=N;
...
save(sprintf('ADNI3_MCI_ABneg_GECglo_cnd_%03d_sch1000_mod_eps_1_2_ratio_SC_max02.mat',cnd),'Ceffgroup');
